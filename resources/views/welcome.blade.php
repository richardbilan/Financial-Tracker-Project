...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{asset('Welcome/ourServices.css')}}" rel="stylesheet" />
    ...
    <div class="bg-white text-black dark:bg-gray-900 dark:text-white/50">
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <div class="wrapper">
        <h1>Our Services</h1>
        <p>Master your money with ease! From smarter expense tracking to achieving your biggest savings goal, 
        we've got the tools to turn your financial dreams into reality. Let us help you take charge and make every peso count!</p>
